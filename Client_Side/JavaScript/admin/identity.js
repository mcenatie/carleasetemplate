...
function createSession()
{
	...
	*/
	$.ajax({
		type: 'POST',
		data: '{"account": "'+config.participants[pgNm.toLowerCase()].uid.split(' ').join('_')+'", "password":"'+config.participants[pgNm.toLowerCase()].password+'"}',
		dataType : 'json',
		...
		error: function(e){
			console.log(config.participants[pgNm.toLowerCase()].uid)
			console.log(e)
		},
		async: false
	});
